...
<body>
    ...
    <div style="font-size: 9pt; text-align: center;">
        <table style="font-size: 9pt; width: 501px; height: 30px; border-right: #0066cc 1px double;border-left: #0066cc 1px double; text-align: center; border-top: 1px double; border-bottom: 1px double;" cellpadding="0" cellspacing="0">
            <tr>
                <td style="background:blue; height: 30px" align="right" valign="bottom">
                    <h2 style="text-align:center;color:white">用户管理</h2>
                    <asp:LinkButton ID="lnkbtnExit" runat="server" OnClick="lnkbtnExit_Click" ForeColor="White">退出</asp:LinkButton>
                </td>
            </tr>
            <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 95px">
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtNewpwd"
                                                ControlToValidate="txtRepwd" ErrorMessage="与密码不符！" Width="73px"></asp:CompareValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 75px">
