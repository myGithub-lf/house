...
<body style="font-size: 9pt; text-align: center;">
    ...
    <div>
        &nbsp;</div>
        <table style="background-image: url(images/templatemo_50p_transprant.png); width: 501px; height: 300px">
            <tr>
            ...
            <tr>
              <td style="height: 203px">
                <table style="font-size: 9pt; width: 367px; height: 136px;margin:auto">
                    <tr>
                        <td style="width: 62px">
                            用户名：</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 164px" align="left">
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPwd" ControlToValidate="txtRepwd" ErrorMessage="确认密码不符!"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 114px; height: 26px">
                            ...
                            <asp:Button ID="btnBack" runat="server" CausesValidation="False" OnClick="btnBack_Click" Text="返回" />
                        </td>
