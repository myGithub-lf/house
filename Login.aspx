...
<body style="font-size: 9pt; text-align: center;">
    <form id="form1" runat="server">
        <table style="background-image: url(images/templatemo_50p_transprant.png); width: 405px; height: 265px">
            <tr>
            ...
            <tr>
              <td>
                <table style="width: 353px; color: #ffffff;margin:auto">
                    <tr>
                        <td style="width: 49px">
                            用户名：</td>
                        <td style="width: 97px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Image ID="Image1" runat="server" Height="22px" Width="58px" ImageUrl="~/ValidateNum.aspx" />
                            请输入图片中验证码！
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" align="left">
                            ...
                            <asp:Button ID="btnRegister" runat="server" Text="注册" OnClick="btnRegister_Click" ForeColor="DodgerBlue" />
                        </td>
                    </tr>
                </table>
              </td>
