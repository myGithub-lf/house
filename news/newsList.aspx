<%@ Page Language="C#" MasterPageFile="~/news/MasterPage.master" AutoEventWireup="true" CodeFile="~/news/newsList.aspx.cs" Inherits="newsList" Title="新闻列表" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table style="height: 580px; width :778px; font-size :9pt" align="center" cellspacing="0" background ="/news/Images/新闻发布系统二级页.jpg">
            <tr style =" width :778px;height: 38px">
                <td colspan="2" style=" height: 38px; font-size :9pt">
                    &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="labTitle" runat="server"  Text="新闻网络中心－＞最新新闻" Width="363px"></asp:Label></td>
            </tr>
            <tr style =" width :778px;height: 38px">
            ...
            <tr style =" width :778px;height: 504px">
                ...
                <asp:Image ID="imageLag" runat="server" Height="79px" ImageUrl="/news/Images/图片时政要闻.jpg" Width="86px" />
                </td>
                <td  style="width :600px; height: 350px; font-size :9pt" valign ="top" >
                    <asp:DataList ID="dlNews" runat="server"  OnItemCommand="dlNews_ItemCommand" Width="225px">
                        <ItemTemplate>
